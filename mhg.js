...
var MHG = function(){
     ...
     * probability of the observed density of ones at the beginning of the
     * vector under the assumption that all possible permutations of the list
     * are equally probable.
     * 
     * The optimal size of the beginning is discovered by iteratively
     * increasing the size and choosing the one with the minimum
